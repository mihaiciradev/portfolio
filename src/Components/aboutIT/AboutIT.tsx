...
const moon = (
  <svg
    ...
    viewBox="0 0 1915 309"
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
  >
    <path
      d="M2 307C466 -98 1425 -100 1915 307"
...
const educationSvg = (
  ...
  >
    <path
      d="M29.433 56L9.98977 43.6333V24.9667L0 18.6667L29.433 0L59 18.6667V43.3222H54.9773V21.3889L48.8761 24.9667V43.6333L29.433 56ZM29.433 32.0444L50.5523 18.6667L29.433 5.52222L8.44773 18.6667L29.433 32.0444ZM29.433 50.7111L44.8534 40.8333V27.7667L29.433 37.3333L14.0125 27.6111V40.8333L29.433 50.7111Z"
      fill="#6C63FF"
    />
  </svg>
);
...
const MoonCircle = ({ svg, id }: { svg: any; id: number }) => {
  ...
  return (
    <div className="moonCircle" onClick={() => click(id)}>
      {svg}
    </div>
  );
};
    ...
    <div id="aboutITPage">
          ...
          <div id="moonTextContainer">
            <div id="state1Text">
              ...
              <div>
                <div>
                  <p>
                    <b>Role:</b> Lead Developer (React &amp; TypeScript)
                  </p>
                  <p>
                    <b>Company:</b> Webbinghub (self-emplyoed)/ AAM / Nautil
                    Paris
                  </p>
                  <p>
                    <b>from:</b> October 2023
                  </p>
                  <p>
                    <b>to:</b> present
                  </p>
                ...
                <div>
                  <p>
                    <b>Role:</b> Fullstack developer (internship)
                  </p>
                  <p>
                    <b>Company:</b> Crafting Software
                  </p>
                  <p>
                    <b>from:</b> February 2022
                  </p>
                  <p>
                    <b>to:</b> May 2022
                  </p>
                ...
                <div>
                  <p>
                    <b>Role:</b> iOS mobile developer (internship)
                  </p>
                  <p>
                    <b>Company:</b> [e-spres-oh]
                  </p>
                  <p>
                    <b>from:</b> September 2020
                  </p>
                  <p>
                    <b>to:</b> December 2020
                  </p>
                </div>
              </div>
            </div>
            ...
            <div id="state2Text">
              ...
              <div>
                <div>
                  ...
                  <p>
                    <b>Specialization:</b> Big data - data science, analytics
                    and technologies
                  </p>
                  <p>
                    <b>University:</b> West University of Timișoara
                  </p>
                  <p>
                    <b>from:</b> September 2022
                  </p>
                  <p>
                    <b>to:</b> July 2025
                  </p>
                ...
                <div>
                  ...
                  <p>
                    <b>Specialization:</b> Computer Science
                  </p>
                  <p>
                    <b>University:</b> West University of Timișoara
                  </p>
                  <p>
                    <b>from:</b> September 2019
                  </p>
                  <p>
                    <b>to:</b> July 2022{" "}
                  </p>
      ...
      <div id="miniCv">
        ...
        <div id="textContainer">
          <p>
            I'm a <b>fullstack web developer</b> specialized in <b>React</b>,{" "}
            <b>TypeScript</b> and <b>Next.js</b>, with strong experience in
            designing and building scalable, real-time web applications. Over
            the last two years I have been actively involved in a complex
            production system where I owned <b>front-end architecture</b>,
            contributed to <b>system design</b>, and coordinated development
            across frontend and backend teams.
          </p>
          <p>
            I am a proactive and reliable team member, known primarily for
            strong <b>problem-solving skills</b>, clear technical communication,
            and the ability to translate business requirements into clean,
            maintainable solutions. I work comfortably with <b>RESTful APIs</b>,
            modern tooling, and <b>Agile</b> processes, while keeping a constant
            focus on code quality, performance, and long-term maintainability.
          </p>
          <p>
            My roots in computer science go back to high school, where I
            competed in the <b>Zero Robotics Competition</b> and later taught{" "}
            <b>Python</b> to 9th-grade students. I hold a Bachelor's in Computer
            Science and a Master's in Big Data &amp; Data Science from{" "}
            <b>West University of Timișoara</b>. I also participated in{" "}
            <b>Oxford Hack 2022</b> at the University of Oxford.
          </p>
          <p>
            Beyond code, I hold a <b>SAFe 5 Practitioner</b> certification and
            have shipped products ranging from ML-powered platforms to
            full-stack booking systems for French travel agencies. I care deeply
            about the craft — building things that not only <b>work reliably</b>{" "}
            but are <b>a pleasure to use</b> 🚀
          </p>
        </div>
      </div>
    </div>
